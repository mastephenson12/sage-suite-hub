          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-5 pt-4">
              ...
              <div className="space-y-4 mb-12">
                <div className="p-5 bg-white border border-zinc-200 rounded-xl shadow-sm hover:border-[#0d47a1]/30 transition-all group">
                  <h4 className="text-[11px] font-[900] uppercase tracking-widest text-[#0d47a1] mb-2">Voice Activated</h4>
                  <p className="text-[14px] text-zinc-600 font-medium">Click the microphone to start a real-time conversation about your travel plans.</p>
                </div>
                <div className="p-5 bg-white border border-zinc-200 rounded-xl shadow-sm hover:border-[#0d47a1]/30 transition-all">
              ...
              <div className="p-8 bg-zinc-950 rounded-2xl text-white">
                ...
                >
                  <input 
                    ...
                    className="px-5 py-3.5 bg-zinc-900 border border-zinc-800 rounded-lg text-sm outline-none focus:border-[#0d47a1]"
                    required
                  />
            ...
            <div className="lg:col-span-7 h-[800px]">
              <ChatInterface className="shadow-2xl shadow-blue-900/10 border-zinc-200" />
            </div>
            ...
            <div className="lg:w-1/2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  ...
                  className="bg-[#0d47a1] hover:bg-[#0a3a85] text-white px-10 py-5 rounded-lg font-black text-sm uppercase tracking-widest transition-all text-center"
                >
                  Enter Member Portal
                </a>
                <a 
          ...
          <div className="max-w-6xl mx-auto px-6 text-center md:text-left">
            <div className="flex flex-col md:flex-row justify-between items-start gap-16">
              <div className="max-w-sm">
                ...
                {/* DEV REMINDER: GitHub Repository Status */}
                <div className="mt-8 p-4 bg-zinc-50 border border-zinc-200 rounded-xl inline-flex flex-col gap-2 text-left">
                  <div className="flex items-center gap-3">
                    <span className="flex h-2 w-2 relative">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-orange-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-orange-500"></span>
                    </span>
                    <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Repo Status: Updates Pending</span>
                  </div>
                  <button 
                    onClick={() => {
                      navigator.clipboard.writeText('git add . && git commit -m "Update ecosystem and community features" && git push');
                      alert("Git command copied to clipboard!");
                    }}
                    className="text-[9px] font-bold text-[#0d47a1] hover:underline uppercase tracking-tighter"
                  >
                    Click to copy Push Command
                  </button>
                </div>
              ...
              <div className="grid grid-cols-2 gap-20 mx-auto md:mx-0">
                <div>
                  ...
                  <ul className="space-y-4 text-[13px] text-zinc-500 font-bold uppercase tracking-widest">
                    <li><a href={BEEHIIV_URL} className="hover:text-[#0d47a1]">Newsletter</a></li>
                    <li><Link to="/trail-guides" className="hover:text-[#0d47a1]">Trail Map</Link></li>
                    <li><Link to="/archive" className="hover:text-[#0d47a1]">Archive</Link></li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-[11px] font-black uppercase tracking-widest text-black mb-8">Association</h4>
                  <ul className="space-y-4 text-[13px] text-zinc-500 font-bold uppercase tracking-widest">
                    <li><Link to="/community" className="hover:text-[#0d47a1]">Community</Link></li>
                    <li><a href={`${SAGESUITE_URL}/directory`} className="hover:text-[#0d47a1]">Directory</a></li>
                    <li><Link to="/about" className="hover:text-[#0d47a1]">Support</Link></li>
                  </ul>
                </div>
              </div>
            </div>
