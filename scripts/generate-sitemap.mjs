...
const staticRoutes = [
  ...
  { path: '/plan', changefreq: 'weekly', priority: '1.0' },
  ...
  { path: '/es/arizona/tonto-natural-bridge-con-ninos', changefreq: 'monthly', priority: '0.9' },
  ...
  { path: '/ru/arizona/papago-park-with-kids', changefreq: 'monthly', priority: '0.9' },
  ...
  { path: '/de/arizona/flagstaff-mit-kindern', changefreq: 'weekly', priority: '0.95' },
  { path: '/de/arizona/prescott-mit-kindern', changefreq: 'weekly', priority: '0.95' },
