  ...
  useEffect(() => {
    const fetchBrief = async () => {
      try {
        ...
        console.error("Satellite sync failed:", e);
        setBrief("Satellite link unstable. Please check official Forest Service alerts for active fire/weather updates.");
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="animate-in fade-in duration-700 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        <div className="lg:col-span-2 space-y-8">
          ...
          {/* Instant Tactical Nodes (Hardcoded Information) */}
            ...
            <div className="p-8 border border-zinc-100 rounded-[32px] bg-zinc-50 hover:bg-white hover:border-black transition-all group">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-zinc-200">
                  ...
                  <p className="text-xs font-bold uppercase tracking-tight leading-tight">Increase hydration by 30% for high-desert summer missions.</p>
                </div>
              </div>
            </div>
          </div>
