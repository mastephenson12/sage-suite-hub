    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="pt-24 pb-20 bg-zinc-950 text-white overflow-hidden relative">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex justify-center gap-4">
            <a href={SAGESUITE_URL} className="bg-[#0d47a1] hover:bg-[#0a3a85] px-8 py-4 rounded-lg font-black uppercase tracking-widest text-sm transition-all shadow-xl shadow-blue-900/20">
              Enter Community
            </a>
      ...
      <section className="py-24 max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-10 bg-zinc-50 rounded-3xl border border-zinc-100 group hover:border-blue-200 transition-all">
            <div className="w-12 h-12 bg-[#0d47a1] rounded-2xl flex items-center justify-center text-white mb-8 shadow-lg shadow-blue-900/20 group-hover:scale-110 transition-transform">
          ...
          <div className="p-10 bg-zinc-50 rounded-3xl border border-zinc-100 group hover:border-blue-200 transition-all">
            <div className="w-12 h-12 bg-blue-500 rounded-2xl flex items-center justify-center text-white mb-8 group-hover:scale-110 transition-transform">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="p-10 bg-zinc-50 rounded-3xl border border-zinc-100 group hover:border-blue-200 transition-all">
            <div className="w-12 h-12 bg-orange-500 rounded-2xl flex items-center justify-center text-white mb-8 group-hover:scale-110 transition-transform">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="py-24 bg-zinc-50 border-y border-zinc-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-8 uppercase leading-tight">A modern ecosystem for <br/>the modern explorer.</h2>
          ...
          <a href={SAGESUITE_URL} className="inline-flex items-center gap-4 bg-black text-white px-12 py-6 rounded-2xl font-black uppercase tracking-[0.2em] hover:bg-[#0d47a1] transition-all shadow-2xl active:scale-95">
